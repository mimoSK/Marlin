...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  X_MAX_POS - (X_MAX_POS * 0.15), Y_MAX_POS / 2 }, { X_MAX_POS - (X_MAX_POS * 0.85),  Y_MAX_POS / 2 } }
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.48    // Unit: mm compression per 1mm/s extruder speed
